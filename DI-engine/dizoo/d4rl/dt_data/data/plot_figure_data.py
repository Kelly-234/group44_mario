...
parser.add_argument(
    '--halfcheetah_ours_csv_path', type=str, default='dt_halfcheetah_log/dt_HalfCheetah-v3_log_22-05-20-06-21-45.csv'
)
parser.add_argument(
    '--halfcheetah_origin_csv_path', type=str, default='dt_halfcheetah_log/dt_HalfCheetah-v3_official.csv'
)
...
df_half_official.columns = [
    'time_elapsed', 'total_updates', 'mean_action_loss', 'eval_avg_reward', 'eval_avg_ep_len', 'd4rl_score'
]
