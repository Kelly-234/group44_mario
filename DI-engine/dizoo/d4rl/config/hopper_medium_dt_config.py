...
hopper_dt_config = dict(
    exp_name='hopper_medium_dt_seed0',
    env=dict(
        env_id='Hopper-v3',
    ...
    policy=dict(
        ...
        n_heads=1,
        dropout_p=0.1,
        log_dir='/home/wangzilin/research/dt/DI-engine/dizoo/d4rl/dt_data/hopper_medium_dt_log',
        model=dict(
            state_dim=11,
            act_dim=3,
            n_blocks=3,
        ...
        nstep=3,
        learn=dict(
            dataset_path='/mnt/lustre/wangzilin/d4rl_data/hopper-medium-v2.pkl',
